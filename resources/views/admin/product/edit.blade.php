                ...
                <div class="card-body">
                    <form action="{{ route('product.update', ['id' => $product->id]) }}" method="post"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id"
                                        class="@error('category_id')is-invalid @enderror select2 form-control ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="min_price" class="form-label">Minimum Price (For bargaining)</label>
                                    @error('min_price')
                                        <h6 class="modal-header justify-content-start"
                                            style="font-weight: 800; color: #FFFFFF; background-color: red; padding-top: 10px;  padding-bottom: 10px; font-size: 12px; max-width: 100%; border-radius: 5px;">
                                            {{ $message }}</h6>
                                    @enderror
                                    <input type="text" step="any" name="min_price"
                                        class="form-control @error('min_price') is-invalid @enderror" id="min_price"
                                        aria-describedby="emailHelp" placeholder="Minimum Price"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="any" name="weight"
                                        ...
                                        aria-describedby="emailHelp" placeholder="Weight"
                                        value="{{ old('weight') ?? $product->currency }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="discount_amount"
                                        ...
                                        id="discount_amount" aria-describedby="emailHelp" placeholder="Discount Price"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="any" name="currency"
                                        ...
                                        aria-describedby="emailHelp" placeholder="Currency"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="any" name="youtube_video_link"
                                        ...
                                        id="youtube_video_link" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card w-100 border shadow">
                                        ...
                                        <div onclick="document.getElementById('image').click()"
                                            ...
                                            id="image-container">
                                            <img style="width:200px" class="mx-auto" id="thumbnil"
                                                src="{{ asset('admin/assets/images/upload.svg') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="Active" class="form-label"><input type="radio" name="status"
                                    value="1" id="Active" {{ $product->status == 1 ? 'checked' : '' }}
                                    class="label radio">Active
                            </label>
                            &nbsp;
                            &nbsp;
                            <label for="Deactive" class="form-label"><input type="radio" name="status"
                                    value="0" id="Deactive" {{ $product->status == 0 ? 'checked' : '' }}
                                    class="label radio">Deactive
                            </label>
                        </div>
                        <div>
